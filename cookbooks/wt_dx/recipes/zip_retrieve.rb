...
archive_url = build_url['url']
install_url = node['webtrends']['dx']['url']
...
windows_zipfile "#{installdir}#{v1_installdir}" do
  source "#{archive_url}dx/#{v1_install_url}"
  action :unzip	
