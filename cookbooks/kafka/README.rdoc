...
* kafa.broker_id - The id of the broker. This must be set to a unique integer for each broker
* kafa.broker_host_name - Hostname the broker will advertise to consumers. If not set, kafka will use the value returned from InetAddress.getLocalHost().
