...
# windows_package "DXInstall" do
	...
	# options "/l*v \"#{logdir}\\#{dx_msi}-Install.log\" INSTALLDIR=\"#{installdir}\" WEBSITE_NAME=\"DX\" MASTER_HOST=\"#{master_host}\" WEBSITE_PORT=\"80\" APP_POOL_ACCT=\"#{app_user}\" APP_POOL_PASS=\"#{app_pass}\" CACHEENABLED=\"True\" CACHENAME=\"#{cache_name}\" CACHE_HOSTS=\"#{cache_hosts}\" CASSANDRA_HOSTNAME=\"#{cass_hosts}\" CASSANDRA_SNMP_COMM=\"#{cass_snmp}\" CASSANDRA_REPORT_FAMILY=\"#{cass_report_family}\" CASSANDRA_METADATA_FAMILY=\"#{cass_metadata_family}\" APP_SETTINGS_SECTION=\"#{app_settings}\""
	# action :install
# end

powershell "reg-iis" do
