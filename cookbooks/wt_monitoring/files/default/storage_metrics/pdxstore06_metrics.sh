#!/bin/bash
#
# Use this script to poll each node in an Isilon cluster that uses OneFS filesystem and then send the collected
...
STORE="pdxstore06"
NODES=('pdxst06cl-1.netiq.dmz' 'pdxst06cl-2.netiq.dmz' 'pdxst06cl-3.netiq.dmz' 'pdxst06cl-4.netiq.dmz' 'pdxst06cl-5.netiq.dmz' 'pdxst06cl-6.netiq.dmz' 'pdxst06cl-7.netiq.dmz' 'pdxst06cl-8.netiq.dmz' 'pdxst06cl-9.netiq.dmz' 'pdxst06cl-10.netiq.dmz' 'pdxst06cl-11.netiq.dmz' 'pdxst06cl-12.netiq.dmz')
