...
default['rundeck']['deb']['package'] = 'rundeck-2.9.3-1-GA.deb' # rundeck package from rundeck-dev bintray
...
default['rundeck']['url'] = "https://dl.bintray.com/rundeck/rundeck-deb/#{node['rundeck']['deb']['package']}"
