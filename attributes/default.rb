...
default['rundeck']['rpm']['package'] = '2.4.2-1.3.GA' # rundeck package from http://dl.bintray.com/rundeck/rundeck-rpm
default['rundeck']['rpm']['config'] = '2.4.2-1.3.GA' # rundeck-config package from http://dl.bintray.com/rundeck/rundeck-rpm
