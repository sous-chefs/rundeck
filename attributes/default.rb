...
default['rundeck']['deb']['package'] = 'rundeck-2.7.1-1-GA.deb'
default['rundeck']['deb']['options'] = false #--force-confdef --force-confold
default['rundeck']['rpm']['version'] = '2.7.1-1.25.GA' # rundeck package from http://dl.bintray.com/rundeck/rundeck-rpm
